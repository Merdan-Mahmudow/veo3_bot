...
from api.routers.referrals import routes as ReferralRoutes
from api.routers.payouts import routes as PayoutRoutes
from api.routers.partners import routes as PartnerRoutes
